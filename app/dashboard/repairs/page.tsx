        ...
        <Card className="w-full max-w-md">
          ...
          <CardContent>
            <p className="text-sm text-muted-foreground">
              Only authorized IT staff members can view repair records. Admins, Head Office IT leads, and Regional IT
              Heads can create repair tasks. If you need IT assistance, please use the Service Desk to submit a support request.
            </p>
          </CardContent>
        </Card>
      </div>
